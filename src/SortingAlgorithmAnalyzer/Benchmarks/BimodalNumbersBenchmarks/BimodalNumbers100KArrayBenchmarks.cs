...
public class BimodalNumbers100KArrayBenchmarks
{
    ...
    public void Setup()
    {
        _originalArray = DatasetGenerator.GenerateBimodalNumbers(100_000, 100, 150, 15);
    }
    ...
    [Benchmark]
    public void BimodalNumbers100KBubbleSort()
    {
        bool swapped;
    ...
    [Benchmark]
    public void BimodalNumbers100KInsertionSort()
    {
    ...
    [Benchmark]
    public void BimodalNumbers100KSelectionSort()
    {
        for (int i = 0; i < _array.Length - 1; i++)
        {
            int minIndex = i;
    ...
    [Benchmark]
    public void BimodalNumbers100KMergeSort()
    {
    ...
    [Benchmark]
    public void BimodalNumbers100KQuickSort()
    {
