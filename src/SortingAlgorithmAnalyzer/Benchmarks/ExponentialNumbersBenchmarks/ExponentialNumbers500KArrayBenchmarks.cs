...
public class ExponentialNumbers500KArrayBenchmarks
{
    ...
    public void Setup()
    {
        _originalArray = DatasetGenerator.GenerateExponentialNumbers(500_000, 1);
    }
    ...
    // [Benchmark]
    // public void ExponentialNumbers500KBubbleSort()
    // {
    //     bool swapped;
    ...
    //
    // [Benchmark]
    // public void ExponentialNumbers500KInsertionSort()
    // {
    ...
    //
    // [Benchmark]
    // public void ExponentialNumbers500KSelectionSort()
    // {
    //     for (int i = 0; i < _array.Length - 1; i++)
    //     {
    //         int minIndex = i;
    ...
    [Benchmark]
    public void ExponentialNumbers500KMergeSort()
    {
    ...
    [Benchmark]
    public void ExponentialNumbers500KQuickSort()
    {
