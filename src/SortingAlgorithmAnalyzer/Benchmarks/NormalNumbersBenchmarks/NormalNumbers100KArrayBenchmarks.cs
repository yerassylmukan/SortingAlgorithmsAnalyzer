...
public class NormalNumbers100KArrayBenchmarks
{
    ...
    public void Setup()
    {
        _originalArray = DatasetGenerator.GenerateNormalNumbers(100_000, 100, 20);
    }
    ...
    // [Benchmark]
    // public void NormalNumbers100KBubbleSort()
    // {
    //     bool swapped;
    ...
    //
    // [Benchmark]
    // public void NormalNumbers100KInsertionSort()
    // {
    ...
    //
    // [Benchmark]
    // public void NormalNumbers100KSelectionSort()
    // {
    //     for (int i = 0; i < _array.Length - 1; i++)
    //     {
    //         int minIndex = i;
    ...
    [Benchmark]
    public void NormalNumbers100KMergeSort()
    {
    ...
    [Benchmark]
    public void NormalNumbers100KQuickSort()
    {
