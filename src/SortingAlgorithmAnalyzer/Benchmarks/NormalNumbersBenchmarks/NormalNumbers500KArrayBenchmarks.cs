...
public class NormalNumbers500KArrayBenchmarks
{
    ...
    public void Setup()
    {
        _originalArray = DatasetGenerator.GenerateNormalNumbers(500_000, 100, 20);
    }
    ...
    [Benchmark]
    public void NormalNumbers500KBubbleSort()
    {
        bool swapped;
    ...
    [Benchmark]
    public void NormalNumbers500KInsertionSort()
    {
    ...
    [Benchmark]
    public void NormalNumbers500KSelectionSort()
    {
        for (int i = 0; i < _array.Length - 1; i++)
        {
            int minIndex = i;
    ...
    [Benchmark]
    public void NormalNumbers500KMergeSort()
    {
    ...
    [Benchmark]
    public void NormalNumbers500KQuickSort()
    {
