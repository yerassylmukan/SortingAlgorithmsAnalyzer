...
public class UniformNumbers100KArrayBenchmarks
{
    ...
    public void Setup()
    {
        _originalArray = DatasetGenerator.GenerateUniformNumbers(100_000, 0, 1000);
    }
    ...
    [Benchmark]
    public void UniformNumbers100KBubbleSort()
    {
        bool swapped;
    ...
    [Benchmark]
    public void UniformNumbers100KInsertionSort()
    {
    ...
    [Benchmark]
    public void UniformNumbers100KSelectionSort()
    {
        for (int i = 0; i < _array.Length - 1; i++)
        {
            int minIndex = i;
