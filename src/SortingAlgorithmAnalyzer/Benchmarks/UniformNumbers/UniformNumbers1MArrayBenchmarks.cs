...
public class UniformNumbers1MArrayBenchmarks
{
    ...
    public void Setup()
    {
        _originalArray = DatasetGenerator.GenerateUniformNumbers(1_000_000, 0, 1000);
    }
    ...
    [Benchmark]
    public void UniformNumbers1MBubbleSort()
    {
        bool swapped;
    ...
    [Benchmark]
    public void UniformNumbers1MInsertionSort()
    {
    ...
    [Benchmark]
    public void UniformNumbers1MSelectionSort()
    {
        for (int i = 0; i < _array.Length - 1; i++)
        {
            int minIndex = i;
