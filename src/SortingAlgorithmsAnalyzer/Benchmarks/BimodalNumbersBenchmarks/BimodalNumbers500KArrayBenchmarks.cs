...
public class BimodalNumbers500KArrayBenchmarks
{
    ...
    public void Setup()
    {
        _originalArray = DatasetGenerator.GenerateBimodalNumbers(500000, 100, 50, 900, 100);
    ...
    [Benchmark]
    public void BimodalNumbers500KQuickSort()
    {
