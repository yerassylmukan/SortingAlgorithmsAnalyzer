...
namespace SortingAlgorithmsAnalyzer.Benchmarks.ExponentialNumbersBenchmarks;
...
public class ExponentialNumbers10KArrayBenchmarks
{
    ...
    [Benchmark]
    public void ExponentialNumbers10KBubbleSort()
    {
        bool swapped;
    ...
    [Benchmark]
    public void ExponentialNumbers10KInsertionSort()
    {
    ...
    [Benchmark]
    public void ExponentialNumbers10KSelectionSort()
    {
        for (int i = 0; i < _array.Length - 1; i++)
        {
            int minIndex = i;
    ...
    [Benchmark]
    public void ExponentialNumbers10KMergeSort()
    {
    ...
    [Benchmark]
    public void ExponentialNumbers10KQuickSort()
    {
